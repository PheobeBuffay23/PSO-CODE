...
public class PSO {
    public static void main(String[] args) {
        ...
        double c1 = 1.5; // cognitivecoeff
        double c2 = 0.10; // socialcoeff
        ...
        for (int i = 0; i < maxiterations; i++) {
            ...
            for (int j = 0; j < 5; j++) {
                ...
                globalbestvalueX = ob.ObjectiveFunction(globalbestX , globalbestY); // globalbestvalue store globalbest*globalbest(ie.
                ...
                if (personalbestfunction < globalbestvalueX  ) { /*
        ...
        System.out.println("the value of gbestX id  " + globalbestvalueX);
        System.out.println("the value of gbestY id " + globalbestvalueY);
